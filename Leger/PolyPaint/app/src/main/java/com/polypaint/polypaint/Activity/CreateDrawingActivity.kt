...
class CreateDrawingActivity: AppCompatActivity(){
    ...
    private fun createDrawing(){
        ...
        canevas = Canevas(UUID.randomUUID().toString(), name, UserHolder.getInstance().username, UserHolder.getInstance().username, accessibility, password,  ArrayList(), ArrayList(), "", Coordinates(0.0,0.0))
