...
class Canevas(var id: String, var name: String, var author: String, var owner: String, var accessibility: Int, var password: String ="", var shapes: ArrayList<BasicShape> = ArrayList(), var links: ArrayList<Link> = ArrayList(), var thumbnailLeger: String, var dimensions: Coordinates): Serializable{
